...
const Evaluation: FC = () => {
  ...
  const [workJournals, setWorkJournals] = useState<Array<number>>([
    0, 0, 0, 0, 0, 0
  ]);
      ...
      <main className="min-w-[1140px] w-full h-full flex flex-col">
        ...
        <div>
          ...
          <div className="mx-32 h-96 overflow-y-auto bg-slate-100 p-4 rounded-[20px] flex mr-4">
            <div className="h-full w-1/2">
              ...
              <div className="w-full h-1/3">
                <p className="font-semibold">
                  새로운 농업 기술 및 방법을 학습하고 적용하는 데 적극적인가?
                </p>
                <div className="flex justify-between p-4 w-11/12">
                  <label>
                    <input
        ...
        <div>
          <div className="relative mx-32 h-64 mt-6 flex flex-col">
            ...
            <textarea
              className="grow border-2 border-gray-300 border-solid resize-none p-4 focus:outline-gray-300  rounded-[20px]"
              onChange={handleTextChange}
              value={textValue}
            ></textarea>
            <button
              className="w-full border-2 border-gray-500 border-solid rounded-md"
