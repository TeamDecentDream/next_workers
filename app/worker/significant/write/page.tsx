...
import SignificantInput from "@/src/components/significant/SignificnatInput";

const SignificantWrite = () => {
  return (
      ...
      <div className="min-w-[1440px] w-full min-h-[900px] flex h-screen">
        ...
        <main className="min-w-[1140px] w-full h-full flex flex-col">
          ...
          <h1 className="font-bold w-full text-3xl my-2 mb-10">공지사항 작성하기</h1>
            <SignificantInput></SignificantInput>
          </div>
          <Footer />
        </main>
      </div>
...
export default SignificantWrite;
